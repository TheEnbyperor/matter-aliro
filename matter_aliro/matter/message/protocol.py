...
class Protocol(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    async def handle_status_report(self, exchange: "message_layer.Exchange", general_code: messages.GeneralCode, protocol_code: int, protocol_data: bytes):
        raise NotImplementedError()

    async def send_status_report(self, exchange: "message_layer.Exchange", general_code: messages.GeneralCode, protocol_code: typing.Optional[int] = None, protocol_data: typing.Optional[bytes] = None, reliability: bool = True):
        ...
        await self._message_layer.send_message(
            exchange=exchange,
    ...
    async def release_next_message(self, exchange: "message_layer.Exchange"):
